...
class SimpleGenericRecyclerAdapter<T : Any>(
    ...
    private var nlistener: onItemClickListener,
) :
    RecyclerView.Adapter<SimpleGenericRecyclerAdapter.ViewHolder>() {
    interface onItemClickListener {
        fun onClick(position: Int, ModelClass: Any)
        fun onLongClick(position: Int, ModelClass: Any)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            nlistener.onClick(position, dataSet[position])
        }
        holder.itemView.setOnLongClickListener {
            nlistener.onLongClick(position, dataSet[position])
